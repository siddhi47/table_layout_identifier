...
class TableInformation:
    ...
    def show_table_info(self):
        ...
        print("Line : {} \nDelimeter : {} \nLength : {}\nDate : {}".format(self.line,self.deli,self.length,self.is_date()))
    ...
    def which_table(self,table_meta, field_meta):
        ...
        date = self.is_date()
        data = pd.read_csv(self.filepath,nrows=5,delimiter=self.show_delimeter(),date_parser=dateparse,parse_dates=date)
        probable = []
